...
namespace OVSP
{
    public partial class Votingmale : System.Web.UI.Page
    {
        SqlConnection con;
        SqlCommand cmd, cmd1, cmd2, cmd3, cmd4, cmd5, cmd6, cmd7, cmd8, cmd9, cmd10, cmd11, cmd12, cmd13, cmd14, cmd15;

        protected void Btnvote4_Click(object sender, EventArgs e)
        {
            con.Open();
            if (int.Parse(TextBox1.Text) < 8)
            {
                str1 = "select vote from Voting where CandidateName='" + Label8.Text + "'";
                cmd3 = new SqlCommand(str1, con);
                dr3 = cmd3.ExecuteReader();
                if (dr3.Read())
                {
                    string y1 = y.ToString();
                    y1 = dr3["vote"].ToString();
                    y = 1 + Convert.ToInt32(y1);
                    str3 = "update Voting set vote='" + y.ToString() + "'where CandidateName='" + Label8.Text + "'";
                    dr3.Close();
                    cmd3 = new SqlCommand(str3, con);
                    cmd3.ExecuteNonQuery();
                    str4 = "insert into Voted values('" + Label8.Text + "')";
                    cmd3 = new SqlCommand(str4, con);
                    cmd3.ExecuteNonQuery();
            ...
            Btnvote4.Enabled = false;
            Btnvote4.BackColor = System.Drawing.Color.DarkRed;
            con.Close();
        }

        protected void Btnvote3_Click(object sender, EventArgs e)
        {
            con.Open();
            if (int.Parse(TextBox1.Text) < 8)
            {
                str1 = "select vote from Voting where CandidateName='" + Label7.Text + "'";
                cmd2 = new SqlCommand(str1, con);
                dr2 = cmd2.ExecuteReader();
                if (dr2.Read())
                {
                    string y1 = y.ToString();
                    y1 = dr2["vote"].ToString();
                    y = 1 + Convert.ToInt32(y1);
                    str3 = "update Voting set vote='" + y.ToString() + "'where CandidateName='" + Label7.Text + "'";
                    dr2.Close();
                    cmd2 = new SqlCommand(str3, con);
                    cmd2.ExecuteNonQuery();
                    str4 = "insert into Voted values('" + Label7.Text + "')";
                    cmd2 = new SqlCommand(str4, con);
                    cmd2.ExecuteNonQuery();
                    // x1 = int.Parse(TextBox1.Text);
                    //x = x1 + 1;
                    //TextBox1.Text = x.ToString();
            ...
            Btnvote3.Enabled = false;
            Btnvote3.BackColor = System.Drawing.Color.DarkRed;
            con.Close();
        }
        ...
        protected void Btnvote2_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(TextBox1.Text) < 8)
            {
                str1 = "select vote from Voting where CandidateName='" + Label6.Text + "'";
                ...
                if (dr1.Read())
                {
                    ...
                    y = 1 + Convert.ToInt32(y1);
                    str3 = "update Voting set vote='" + y.ToString() + "'where CandidateName='" + Label6.Text + "'";
                    dr1.Close();
                    cmd1 = new SqlCommand(str3, con);
                    cmd1.ExecuteNonQuery();
                    str4 = "insert into Voted values('" + Label6.Text + "')";
        ...
        protected void Btnvote1_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(TextBox1.Text) < 8)
            {
                str1 = "select vote from Voting where CandidateName='" + Label5.Text + "'";
                ...
                if (dr.Read())
                {
                    ...
                    y1 = dr["vote"].ToString();
                    y = 1 + Convert.ToInt32(y1);
                    str3 = "update Voting set vote='" + y.ToString() + "'where CandidateName='" + Label5.Text + "'";
                    dr.Close();
                    cmd = new SqlCommand(str3, con);
                    cmd.ExecuteNonQuery();
                    str4 = "insert into Voted values('" + Label5.Text + "')";
