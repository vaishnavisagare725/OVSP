...
namespace OVSP
{
    public partial class Votingfemale : System.Web.UI.Page
    {
        SqlConnection con;
        ...
        protected void Btnvote4_Click(object sender, EventArgs e)
        {
            ...
            {
                str1 = "select vote from Votingfemale where CandiadateName='" + Label8.Text + "'";
                ...
                if (dr3.Read())
                {
                    ...
                    str3 = "update Votingfemale set vote='" + y.ToString() + "'where CandiadateName='" + Label8.Text + "'";
                    dr3.Close();
                    cmd3 = new SqlCommand(str3, con);
                    cmd3.ExecuteNonQuery();
                    str4 = "insert into Votedfem values('" + Label19.Text + "')";
        ...
        protected void Btnvote3_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(TextBox1.Text) < 8)
            {
                str1 = "select vote from Votingfemale where CandiadateName='" + Label7.Text + "'";
                ...
                if (dr2.Read())
                {
                    ...
                    y = 1 + Convert.ToInt32(y1);
                    str3 = "update Votingfemale set vote='" + y.ToString() + "'where CandiadateName='" + Label7.Text + "'";
                    dr2.Close();
        ...
        protected void Btnvote2_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(TextBox1.Text) < 8)
            {
                str1 = "select vote from Votingfemale where CandiadateName='" + Label6.Text + "'";
                ...
                if (dr1.Read())
                {
                    ...
                    y = 1 + Convert.ToInt32(y1);
                    str3 = "update Votingfemale set vote='" + y.ToString() + "'where CandiadateName='" + Label6.Text + "'";
                    dr1.Close();
        ...
        protected void Btnvote1_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(TextBox1.Text) < 8)
            {
                str1 = "select vote from Votingfemale where CandiadateName='" + Label5.Text + "'";
                ...
                if (dr.Read())
                {
                    ...
                    y1 = dr["vote"].ToString();
                    y = 1 + Convert.ToInt32(y1);
                    str3 = "update Votingfemale set vote='" + y.ToString() + "'where CandiadateName='" + Label5.Text + "'";
                    dr.Close();
