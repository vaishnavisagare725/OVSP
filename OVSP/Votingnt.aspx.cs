...
namespace OVSP
{
    public partial class Votingnt : System.Web.UI.Page
    {
        SqlConnection con;
        ...
        protected void Btnvote2_Click(object sender, EventArgs e)
        {
            ...
            {
                str1 = "select vote from Votingnt where CandidateName='" + Label6.Text + "'";
                ...
                if (dr1.Read())
                {
                    ...
                    str3 = "update Votingnt set vote='" + y.ToString() + "'where CandidateName='" + Label6.Text + "'";
                    dr1.Close();
                    cmd1 = new SqlCommand(str3, con);
                    cmd1.ExecuteNonQuery();
                    str4 = "insert into Votednt values('" + Label19.Text + "')";
        ...
        protected void Btnvote1_Click(object sender, EventArgs e)
        {
            ...
            if (int.Parse(TextBox1.Text) < 8)
            {
                str1 = "select vote from Votingnt where CandidateName='" + Label5.Text + "'";
                ...
                if (dr.Read())
                {
                    ...
                    y1 = dr["vote"].ToString();
                    y = 1 + Convert.ToInt32(y1);
                    str3 = "update Votingnt set vote='" + y.ToString() + "'where CandidateName='" + Label5.Text + "'";
                    dr.Close();
